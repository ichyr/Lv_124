Feature: Administration panel, list of administration 
    ...
    Scenario: Open Administration panel, list of administration as administrator 
        ...
        And list of administration and moderator privileges users and all their infotmation 
        |name of user| |email of user| |status| |change status button| |delete user button|
        And in the bottom of page i see footer menu
        
    Scenario: Open Administration panel, list of administration as an user without administration privileges
